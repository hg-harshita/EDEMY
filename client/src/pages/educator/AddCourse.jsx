      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        ...
        <div className='flex items-center justify-between flex-wrap'>
          <div className='flex flex-col gap-1'>
            ...
            className='outline-none md:py-2.5 py-2 w-28 px-3 rounded border-gray-500' required />
            </div>
         ...
         <div>
          {chapters.map((chapter, chapterIndex) => (
                <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
                   <div className='flex justify-between items-center p-4 border-b'>
                    ...
                    src={assets.dropdown_icon} width={14} alt=" " className={`mr-2 cursor-pointer tranistion-all ${chapter.collapsed && "-rotate-90"}`}/>
          ...
          <div className='flex justify-center items-center bg-blue-100 p-2 rounded-lg cursor-pointer' onClick={() =>
